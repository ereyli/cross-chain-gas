  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      <button
        ...
        disabled={disabled}
        className={`w-full pl-12 pr-10 py-3 bg-white/70 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all appearance-none cursor-pointer text-left flex items-center ${
